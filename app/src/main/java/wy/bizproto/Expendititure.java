...
public class Expendititure extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_expendititure);
    ...
    public void gotoBudgeting(View view){
    ...
    public void gotoSummary(View view){
        Intent intent = new Intent(this,Summary1.class);
        startActivity(intent);
    }

    public void gotoTransactionHisotry(View view){
